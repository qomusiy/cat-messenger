...
const handlebarsPlugin = handlebars({
  context: {
    title: 'Cat Messenger',
    description: 'Cat Messenger is a fast, secure, cloud-based messaging app.',
...
export default defineConfig({
  ...
  build: {
    target: 'es2020',
    // Sourcemaps are ~30MB of an otherwise ~42MB dist — worth keeping locally,
    // not worth uploading on every deploy. render.yaml sets SOURCEMAP=0.
